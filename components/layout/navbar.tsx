                ...
                <div className="h-full w-full rounded-md bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center">
                  <div className="text-center p-4">
                    <Image
                      ...
                      width={72}
                      height={72}
                      className="mx-auto mb-2 bg-gradient-to-tr border-secondary from-primary via-primary/70 to-primary rounded-lg w-18 h-18 border text-white"
                    />
                    
                    <h2 className="text-2xl font-bold mb-1">Veritas</h2>
                    <p className="text-sm text-muted-foreground">
                      Transparent Claim Verification
                    </p>
                  </div>
                </div>
